...
# raw data save path
data_path = "/mnt/data1/cxq/2014001/BCICIV_2a_gdf/"

fs = 250
MI_duration = 4 #4s
Fstop1 = 8
Fstop2 = 32
save_file = "/mnt/data1/cxq/processedMI2014001/s{}{}.mat"

if not os.path.exists("/mnt/data1/cxq/processedMI2014001/"):
    os.makedirs("/mnt/data1/cxq/processedMI2014001/")
...
def get_one_sub(sid):
    ...
    # extract, preprocess, and save the data from the first session.
    X = []
    Y = []
...
def MI2014001save():
    ...
    save_file = "/mnt/data1/cxq/processedMI2014001_4s_sea/s{}.mat"

    if not os.path.exists("/mnt/data1/cxq/processedMI2014001_4s_sea/"):
        os.makedirs("/mnt/data1/cxq/processedMI2014001_4s_sea/")
    ...
    for i in range(9):
        ...
        save_file = "/mnt/data1/cxq/processedMI2014001_4s_sea/s{}E.mat"
        ...
        save_file = "/mnt/data1/cxq/processedMI2014001_4s_sea/s{}T.mat"
