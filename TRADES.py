...
if __name__ == '__main__':
    ...
    # ========================savings=======================
    model_path = f'/mnt/data1/cxq/advbenchmark/bci_adv_defense_model/TRADES_{args.AT_eps}/{args.dataset}/{args.model}/{args.setup}'
    if args.online:
        model_path = f'/mnt/data1/cxq/advbenchmark/bci_adv_defense_model/online_TRADES_{args.AT_eps}/{args.dataset}/{args.model}/{args.setup}'

    log_path = f'/home/xqchen/bci_adv_defense-main_copy/log/TRADES_{args.AT_eps}'
    if args.online:
        log_path = f'/home/xqchen/bci_adv_defense-main_copy/log/online_TRADES_{args.AT_eps}'
    if not os.path.exists(log_path):
        os.makedirs(log_path)
    log_name = os.path.join(log_path, f'{args.setup}_{args.dataset}_{args.model}.log')
    
    excel_path = f'/home/xqchen/bci_adv_defense-main_copy/excel/TRADES_{args.AT_eps}'
    if args.online:
        excel_path = f'/home/xqchen/bci_adv_defense-main_copy/excel/online_TRADES_{args.AT_eps}'
