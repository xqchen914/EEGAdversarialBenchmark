...
if __name__ == '__main__':
    ...
    parser.add_argument('--epss', nargs='+',type=float,default=[0.01,0.03,0.05])#evaluated attack perturbation amplitudes
    ...
    # ========================savings=======================
    model_path = f'/mnt/data1/cxq/advbenchmark/bci_adv_defense_model/AT_{args.AT_eps}/{args.dataset}/{args.model}/{args.setup}'
    if args.online:
        model_path = f'/mnt/data1/cxq/advbenchmark/bci_adv_defense_model/online_AT_{args.AT_eps}/{args.dataset}/{args.model}/{args.setup}'


    log_path = f'/home/xqchen/bci_adv_defense-main_copy/log/AT_{args.AT_eps}'
    if args.online:
        log_path = f'/home/xqchen/bci_adv_defense-main_copy/log/online_AT_{args.AT_eps}'
    if not os.path.exists(log_path):
        os.makedirs(log_path)
    log_name = os.path.join(log_path, f'{args.setup}_{args.dataset}_{args.model}.log')
    
    excel_path = f'/home/xqchen/bci_adv_defense-main_copy/excel/AT_{args.AT_eps}'
    if args.online:
        excel_path = f'/home/xqchen/bci_adv_defense-main_copy/excel/online_AT_{args.AT_eps}'
