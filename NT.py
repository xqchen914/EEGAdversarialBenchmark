...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='EEGNet')# DeepCNN ShadowCNN EEGNet
    parser.add_argument('--dataset', type=str, default='ssvep')
    ...
    # parser.add_argument('--aug', type=str, default='no')# no rand noise mult neg freq
    ...
    # ========================savings=======================
    model_path = f'/mnt/data1/cxq/advbenchmark/bci_adv_defense_model/NT/{args.dataset}/{args.model}/{args.setup}'
    if args.online:
        model_path = f'/mnt/data1/cxq/advbenchmark/bci_adv_defense_model/online_NT/{args.dataset}/{args.model}/{args.setup}'
    if args.noea:
        model_path = f'/mnt/data1/cxq/advbenchmark/bci_adv_defense_model/noea_NT/{args.dataset}/{args.model}/{args.setup}'


    log_path = f'/home/xqchen/bci_adv_defense-main_copy/result/log/NT'
    if args.online:
        log_path = f'/home/xqchen/bci_adv_defense-main_copy/result/log/online_NT'
    if args.noea:
        log_path = f'/home/xqchen/bci_adv_defense-main_copy/result/log/noea_NT'
    ...
    excel_path = f'/home/xqchen/bci_adv_defense-main_copy/result/excel/NT'
    if args.online:
        excel_path = f'/home/xqchen/bci_adv_defense-main_copy/result/excel/online_NT'
    if args.noea:
        excel_path = f'/home/xqchen/bci_adv_defense-main_copy/result/excel/noea_NT'
